...
public class ResourceSystemController {
	...
	/*
	@GetMapping(value = ResourceSystemConstants.REQUEST_RESOURCE_URI)
	@ResponseBody
	public ResourceResponseDTO requestResource(@RequestBody final PolicyRequestDTO dto) throws Exception {} */

	/*
	@GetMapping(value = ResourceSystemConstants.FETCH_RESOURCE_URI)
	@ResponseBody
